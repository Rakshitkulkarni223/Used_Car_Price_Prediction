...
try:
    ...
    execfile('Used_car_price_prediction.py')
    model = open('car.pkl', 'rb')
    regressor = pickle.load(model)
...
def predict():
    ...
    if request.method == 'POST':
        ...
        Price = regressor.predict([[
            Year, Kms, Own, Mileage, Engine, Power, Seat, AUDI, BENTLEY, BMW, CHEVROLET, DATSUN, FIAT, FORCE, FORD,
            HONDA,
        ...
        return render_template('lsp.html',prediction_text="Your car's price should be Rs. {} lakhs. This price may change depending on the condition of the car.".format(output))
